...
for i in range(MAX_EPISODES):
    ...
    print(f"Episode {i}: reward = {float(ep_reward):.2f}, greedy = {float(ep_reward_greedy):.2f}, random = {float(ep_reward_random):.2f}, explore = {var:.2f}")
...
plt.xlabel("Episode")
plt.ylabel("Episodic Reward - Average Data Rate (NPCU)")
